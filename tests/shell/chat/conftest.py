...
is pinned one directory down, in ``tests/shell/monitor_ui/``.
...
from agentclip.shell.monitor_ui import CalibrationRunner
...
class Harness:
    ...
    def __init__(
        ...
        # a suite of its own in tests/shell/monitor_ui/.
