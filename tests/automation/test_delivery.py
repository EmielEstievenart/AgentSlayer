...
:class:`~agentclip.automation.ops.ScreenOps` - subclassed below into a scripted
one, which is exactly what the Textual shell hands in. Everything the sequence
still has to ASK a shell is :class:`~agentclip.automation.host.AutomationHost`,
...
from agentclip.automation.ops import ScreenOps
...
class ScriptedOps(ScreenOps):
    ...
    A subclass rather than a monkeypatch of ``agentclip.automation.ops``' names,
