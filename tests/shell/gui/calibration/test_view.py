...
from agentclip.shell.gui.calibration.view import (
    ELEMENT_LABEL,
    ELEMENT_MISSING,
    ELEMENT_ORDER,
    ELEMENT_RESTING,
...
from tests.shell.gui.calibration.conftest import CalibHarness

VIEW = "agentclip.shell.gui.calibration.view"
EDITOR = "agentclip.shell.gui.service_editor"
