...
local vs a remote session) is tested in tests/executor/mcp/test_load_config.py - nothing
...
from agentclip.executor.mcp.types import DEFAULT_TIMEOUT_MS, McpLocalServer, McpRemoteServer
