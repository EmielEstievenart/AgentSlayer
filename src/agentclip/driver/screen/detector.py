...
* ``BUSY`` / ``IDLE`` through a :class:`~agentclip.driver.screen.presence.PresenceTracker`
...
* the drawn region's own stillness through a
  :class:`~agentclip.driver.screen.stale.StaleTracker`, when the checklist ticks it -
...
from agentclip.driver.screen.matchers import DEFAULT_MATCHER, Matcher, select_matcher
