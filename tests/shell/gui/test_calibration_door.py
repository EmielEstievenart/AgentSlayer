...
(tests/shell/gui/conftest.py). The window's own surface is pinned one directory
down, in ``tests/shell/gui/calibration/``.
"""
...
from agentclip.shell.gui.view import CALIBRATION_OPEN, GuiView
