...
:class:`ScreenOps` is the handful of :mod:`agentclip.driver.screen` calls the OS-acting
sequences in :class:`~agentclip.driver.automation.controller.AutomationController` make
...
default implementation below simply calls ``agentclip.driver.screen`` directly, which
