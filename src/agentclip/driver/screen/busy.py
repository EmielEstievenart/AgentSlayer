...
:mod:`agentclip.driver.screen.presence` (is this appearance visible anywhere in the
chat region?) and :mod:`agentclip.driver.screen.stale` (has the chat region stopped
...
class BusyProbe:
    ...
    :mod:`agentclip.driver.screen.presence`). That default is the right bias for a
