...
from agentclip.shell.gui import docs as gui_docs
from agentclip.shell.gui.docs import DOC_PAGES, load_doc_pages, repo_doc_dir
from tests.shell.gui.conftest import Harness
from tests.shell.gui.test_chrome import KeySpy, api_of

REPO = Path(__file__).resolve().parents[3]
ASSETS = REPO / "src" / "agentclip" / "shell" / "gui" / "assets"
...
def test_the_spec_and_the_wheel_ship_the_guide_where_the_reader_looks() -> None:
    ...
    assert "gui_datas + doc_datas" in spec, "collected but never handed to Analysis"
